...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/chatbot
```

A live public deployment of this template is available at [https://chatbot.templates.workers.dev](https://chatbot.templates.workers.dev)
